...
As our protected group is Ethnicity, we can plot amount of observations in particular class.   
...
```{r}
fap <- performance_with_fairness(fobject, fairness_metric = "FPR_parity_loss")
plot(fap)
```
...
p1 <- plot(performance_with_fairness(fobject,  "TPR_parity_loss", "accuracy"))
p2 <- plot(performance_with_fairness(fobject,  "FPR_parity_loss", "auc"))     + ggtitle(" ") + theme(legend.position = "none")
p3 <- plot(performance_with_fairness(fobject,  "NPV_parity_loss", "recall"))  + ggtitle(" ") + theme(legend.position = "none")
p4 <- plot(performance_with_fairness(fobject,  "TS_parity_loss", "f1"))+ ggtitle(" ") + theme(legend.position = "none")
...
plot_two_models(fobject2, fairness_metric = "FPR")
```
