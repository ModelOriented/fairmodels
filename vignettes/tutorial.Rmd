...
```{r}
plot_performance_with_fairness(fobject, fairness_metric = "FPR_parity_loss")
```
...
p1 <- plot_performance_with_fairness(fobject,  "TPR_parity_loss", "accuracy")
p2 <- plot_performance_with_fairness(fobject,  "FPR_parity_loss", "auc")     + ggtitle(" ") + theme(legend.position = "none")
p3 <- plot_performance_with_fairness(fobject,  "NPV_parity_loss", "recall")  + ggtitle(" ") + theme(legend.position = "none")
p4 <- plot_performance_with_fairness(fobject,  "TS_parity_loss", "f1")+ ggtitle(" ") + theme(legend.position = "none")
