...
```{r}
fobject <- create_fairness_object(explainer_1,explainer_2,explainer_3,explainer_4,explainer_5,
                                  data = compas, 
...
```{r}
plot_heatmap(fobject, scale = TRUE) # we can turn values off via text= FALSE
```
...
p2 <- plot_performance_with_fairness(fobject,  "fpr_parity", "auc") + ggtitle(" ")
p3 <- plot_performance_with_fairness(fobject,  "npv_parity", "recall")+ ggtitle(" ")
p4 <- plot_performance_with_fairness(fobject,  "pred_rate_parity", "f1")+ ggtitle(" ")
