...
p1 <- plot(performance_and_fairness(fobject_without_cutoff, fairness_metric = "TPR_parity_loss"))
p2 <- plot(performance_and_fairness(fobject_with_cutoff, fairness_metric = "TPR_parity_loss"))
