...
p2 <- plot(performance_and_fairness(fobject,  "FPR", "auc"))     +
  ggtitle(" ") +
  theme(legend.position = "none")
p3 <- plot(performance_and_fairness(fobject,  "NPV", "recall"))  +
  ggtitle(" ") +
  theme(legend.position = "none")
p4 <- plot(performance_and_fairness(fobject,  "TS", "f1")) +
  ggtitle(" ") +
  theme(legend.position = "none")
...
```{r}
cpc <- ceteris_paribus_cutoff(fobject2, subgroup = "African_American", cumulated = TRUE)
